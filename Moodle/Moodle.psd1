...
@{
    ...
    FunctionsToExport = @('Add-MoodleCohortMember', 'Connect-Moodle', 'Disconnect-Moodle', 'Get-MoodleCohort', 'Get-MoodleCohortMember', 'Get-MoodleCourse', 'Get-MoodleCourseCategory', 'Get-MoodleCurrentSessionInfo', 'Get-MoodleEnrolledUser', 'Get-MoodleGroup', 'Get-MoodleGroupMember', 'Get-MoodleUser', 'Get-MoodleUserCourse', 'New-MoodleCohort', 'New-MoodleEnrolment', 'New-MoodleGroup', 'New-MoodleUser', 'Remove-MoodleCohort', 'Remove-MoodleCohortMember', 'Remove-MoodleEnrolment', 'Remove-MoodleGroup', 'Set-MoodleCohort', 'Set-MoodleGroup', 'Set-MoodleUser')
